...
const GAME_VERSIONS = [
    ...
    { id:"yw2", label:"Yo-kai Watch 2 - Bony Spirits",           icon:"icons/ykw2bonyspirits.png",  test:/bony|honke/i },
    { id:"yw2", label:"Yo-kai Watch 2 - Fleshy Souls",           icon:"icons/ykw2fleshysouls.png",  test:/fleshy|ganso/i },
    { id:"yw2", label:"Yo-kai Watch 2 - Psychic Specters",       icon:"icons/ykw2psycicspecters.png",test:/psychic|shinuchi/i },
    { id:"yw3", label:"Yo-kai Watch 3 - Sushi",                  icon:"icons/ykw3sushi.png",        test:/sushi/i },
    { id:"yw3", label:"Yo-kai Watch 3 - Tempura",                icon:"icons/ykw3tempura.png",      test:/tempura/i },
    { id:"yw3", label:"Yo-kai Watch 3 - Sukiyaki",               icon:"icons/ykw3sukiyaki.png",     test:/sukiyaki/i },
    { id:"yw3", label:"Yo-kai Watch 3 (International)",          icon:"icons/ykw3international.png", test:/international|us\b|eu\b/i },
    { id:"ykb", label:"Yo-kai Watch Blasters - Red Cat Corps",    icon:"icons/blasters1redcat.png",   test:/red\s*cat/i },
    { id:"ykb", label:"Yo-kai Watch Blasters - White Dog Squad",  icon:"icons/blasters1whitedog.png", test:/white\s*dog/i },
    { id:"ykb", label:"Yo-kai Watch Blasters",                   icon:"icons/blasters1_generic.png" },
    { id:"b2",  label:"Yo-kai Watch Blasters 2 - Sword",         icon:"icons/blasters2sword.png",    test:/sword/i },
    { id:"b2",  label:"Yo-kai Watch Blasters 2 - Magnium",       icon:"icons/blasters2magnium.png",  test:/magnium/i },
